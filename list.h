...
/* Calls the given function (if non-zero) on the first node before destroing it,
 ...
 * before destroing it, returns the head of list. */
...
/* Walks through list until the given function returns zero. */
 ...
 * by the given three-way comparison function before destroing it, returns
 * the head of list. */
